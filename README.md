...
| Plik | Opis |
|------|------|
| `Animacje2.0/` + `Animacje2.0.zip` | **AKTUALNA (2.0)**: nowy silnik od zera — **50 animowanych efektów + 11 czystych kolorów**, każdy efekt w osobnym pliku |
...
- **50 efektów animowanych** — wszystkie wyraźnie animowane (zero subtelnych); pełna lista: `python3 narzedzia/konwerter.py --lista`
  ...
  - serie tematyczne: neon (18), kruszce i kamienie (15), łączenia (40), ruchy 156-205, seria hakerska (10) + **wybrane efekty z partii 216-280: lampa, laser, fala2, skaner, gwiazdy, pulsar, drganie, skok, wahadlo, wir, kap, dryf, matrix (13 rodzin × 5)**
