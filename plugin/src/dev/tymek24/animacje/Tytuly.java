...
public final class Tytuly {
    ...
    public void wyslij(Player target, Katalog.Fx fx, String title, String subtitle) {
        ...
        String main = Tekst.animowany(fx, Narzedzia.ogranicz(title, 80));
        String sub = subtitle == null || subtitle.isBlank() ? "" : Tekst.animowany(fx, Narzedzia.ogranicz(subtitle, 100));
