...
TAGS = {
    ...
    'matrix_fiolet': '#1200FC',    "perla": "#130000",
    "mgla": "#130004",
    "szafir": "#130008",
    "rubin": "#13000C",
    "szmaragd": "#130010",
...
def main():
    ...
    if args and args[0] == "--lista":
        print("256 animowanych (wszystkie = kolor + ruch):")
        for t, i, h, typ in [
...
("matrix_fiolet",279,"1200FC","kolor"),
            ("perla",281,"130000","kolor"),
            ("mgla",282,"130004","kolor"),
            ("szafir",283,"130008","kolor"),
            ("rubin",284,"13000C","kolor"),
            ("szmaragd",285,"130010","kolor"),
            ("bursztyn",286,"130014","kolor"),
            ("lodowy",287,"130018","kolor"),
            ("iskry",288,"13001C","kolor"),
            ("falowanie",289,"130020","kolor"),
            ("poziomice",290,"130024","kolor"),
            ("metal",291,"130028","kolor"),
            ("woda",292,"13002C","kolor"),
            ("noc",293,"130030","kolor"),
            ("poranek",294,"130034","kolor"),
            ("pustynia",295,"130038","kolor"),
            ("wino",296,"13003C","kolor"),
            ("swieca",297,"130040","kolor"),
            ("chmura",298,"130044","kolor"),
            ("mech",299,"130048","kolor"),
            ("lawenda",300,"13004C","kolor"),
        ]:
