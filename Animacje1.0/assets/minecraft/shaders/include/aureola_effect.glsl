void applyAureolaEffect(vec2 uv, vec4 baseColor, vec4 effectColor, vec4 effectParams,
    ...
    float hueT = fract(t * 0.2 + vNorm * 0.3);
    ...
    vec3 color = baseColor.rgb + vec3(r, g, b) * edge * 2.5 * intensity;
